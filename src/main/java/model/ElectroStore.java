...
public class ElectroStore implements Store {

    private static ElectroStore instance;
    private static StoreDao storeDao = new StoreJDBCDao();
    private int id;
    private String title;
    private List<Category> categories = new ArrayList<>();

    private ElectroStore() {
    }
    ...
    public static Store getInstance() {
        if (instance == null) {
            synchronized (ElectroStore.class) {
                if (instance == null) {
                    instance = new ElectroStore();
                    instance.setId(2);
                    instance = (ElectroStore) storeDao.read(instance);
                }
            }
        }
        return instance;
